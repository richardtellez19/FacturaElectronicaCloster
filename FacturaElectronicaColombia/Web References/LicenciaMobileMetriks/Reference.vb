...
'
Namespace LicenciaMobileMetriks
    ...
    Partial Public Class Service1
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.FacturaElectronicaColombia.My.MySettings.Default.FacturaElectronicaColombia_LicenciaMobileMetriks_Service1
